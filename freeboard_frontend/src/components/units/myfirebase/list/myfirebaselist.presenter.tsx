import type { IMyfirebaseListUIProps } from "./myfirebaselist.type";
import * as S from "./myfirebaselist.style";
import { v4 as uuidv4 } from "uuid";

export default function MyFireBaseListPageUI(props: IMyfirebaseListUIProps) {
  return (
    <S.Wrapper>
      <S.Row>
